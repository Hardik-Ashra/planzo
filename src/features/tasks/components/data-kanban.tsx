...
export const DataKanban = ({ data, onChange }: DataKanbanProps) => {
    ...
    const onDragEnd = useCallback((result: DropResult) => {
        ...
        setTasks((prevTasks) => {
            ...
            // Update task status only if moved to different column
            ...
            // Build updates payload for backend sync
            ...
            // Update positions in source column if column changed
            ...
            // Trigger backend update after state change
